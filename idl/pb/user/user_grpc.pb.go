...
// UserServiceClient is the woker API for UserService service.
//
...
func (c *userServiceClient) UserLogin(ctx context.Context, in *UserLoginReq, opts ...grpc.CallOption) (*UserDetailResponse, error) {
...
func (c *userServiceClient) UserRegister(ctx context.Context, in *UserRegisterReq, opts ...grpc.CallOption) (*UserCommonResponse, error) {
...
func (UnimplementedUserServiceServer) UserLogin(context.Context, *UserLoginReq) (*UserDetailResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UserLogin not implemented")
}
func (UnimplementedUserServiceServer) UserRegister(context.Context, *UserRegisterReq) (*UserCommonResponse, error) {
