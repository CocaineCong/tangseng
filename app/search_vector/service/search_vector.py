...
class SearchVectorService(search_vector_pb2_grpc.SearchVectorServiceServicer):
    ...
    def SearchVector(self, request, context) -> search_vector_pb2.SearchVectorResponse:
        try:
            ...
            return search_vector_pb2.SearchVectorResponse(code=200, doc_ids=doc_ids, msg='ok', error='')
        except Exception as e:
            print("search vector error", e)
            return search_vector_pb2.SearchVectorResponse(code=500, doc_ids='', msg='fail', error=str(e))
