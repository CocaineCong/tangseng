...
type FavoritesDetailResponse struct {
	...
	FavoritesDetail *FavoritesModel `protobuf:"bytes,1,opt,name=FavoritesDetail,proto3" json:"FavoritesDetail,omitempty"`
...
var file_favoriteService_proto_rawDesc = []byte{
	...
	0xc5, 0x02, 0x0a, 0x10, 0x46, 0x61, 0x76, 0x6f, 0x72, 0x69, 0x74, 0x65, 0x73, 0x53, 0x65, 0x72,
	...
	0x6d, 0x6f, 0x6e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x3a, 0x0a, 0x0e, 0x46,
	0x61, 0x76, 0x6f, 0x72, 0x69, 0x74, 0x65, 0x41, 0x64, 0x64, 0x55, 0x72, 0x6c, 0x12, 0x14, 0x2e,
	0x70, 0x62, 0x2e, 0x46, 0x61, 0x76, 0x6f, 0x72, 0x69, 0x74, 0x65, 0x73, 0x52, 0x65, 0x71, 0x75,
...
var file_favoriteService_proto_depIdxs = []int32{
	...
	0, // 6: pb.FavoritesService.FavoriteAddUrl:input_type -> pb.FavoritesRequest
	2, // 7: pb.FavoritesService.FavoriteCreate:output_type -> pb.CommonResponse
	2, // 8: pb.FavoritesService.FavoriteUpdate:output_type -> pb.CommonResponse
	1, // 9: pb.FavoritesService.FavoriteShow:output_type -> pb.FavoritesDetailResponse
	2, // 10: pb.FavoritesService.FavoriteDelete:output_type -> pb.CommonResponse
	2, // 11: pb.FavoritesService.FavoriteAddUrl:output_type -> pb.CommonResponse
...
type FavoritesServiceClient interface {
	...
	FavoriteAddUrl(ctx context.Context, in *FavoritesRequest, opts ...grpc.CallOption) (*CommonResponse, error)
}
...
func (c *favoritesServiceClient) FavoriteAddUrl(ctx context.Context, in *FavoritesRequest, opts ...grpc.CallOption) (*CommonResponse, error) {
	out := new(CommonResponse)
	err := c.cc.Invoke(ctx, "/pb.FavoritesService/FavoriteAddUrl", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type FavoritesServiceServer interface {
	...
	FavoriteAddUrl(context.Context, *FavoritesRequest) (*CommonResponse, error)
}
...
func (*UnimplementedFavoritesServiceServer) FavoriteAddUrl(context.Context, *FavoritesRequest) (*CommonResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method FavoriteAddUrl not implemented")
}
...
func _FavoritesService_FavoriteAddUrl_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(FavoritesRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(FavoritesServiceServer).FavoriteAddUrl(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pb.FavoritesService/FavoriteAddUrl",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(FavoritesServiceServer).FavoriteAddUrl(ctx, req.(*FavoritesRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _FavoritesService_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "FavoriteAddUrl",
			Handler:    _FavoritesService_FavoriteAddUrl_Handler,
		},
	},
